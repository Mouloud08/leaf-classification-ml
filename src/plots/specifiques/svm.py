"""Graphiques spécifiques pour le SVM."""
...
def tracer_heatmap_C_gamma(
    ...
    titre: str = "Carte thermique C vs gamma",
...
def tracer_support_vectors_par_classe(
    info: dict[str, Any],
    titre: str = "Vecteurs de support par classe",
) -> plt.Figure:
...
def tracer_learning_curve_svm(
    ...
    titre: str = "Courbe d'apprentissage (SVM)",
) -> plt.Figure:
    """Trace la courbe d'apprentissage du SVM."""
