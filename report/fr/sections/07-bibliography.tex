...
\begin{itemize}
    ...
    \item Cawley, G. C., \& Talbot, N. L. C. (2010). \emph{On over-fitting in model sélection and subsequent sélection bias in performance évaluation}. \emph{Journal of Machine Learning Research, 11}, 2079-2107.
    ...
    \item scikit-learn developers. (n.d.). \emph{Model évaluation: Quantifying the quality of prédictions}. \url{https://scikit-learn.org/stable/modules/model_evaluation.html}
    ...
    \item Varma, S., \& Simon, R. (2006). \emph{Bias in error estimation when using cross-validation for model sélection}. \emph{BMC Bioinformatics, 7}, Article 91.\\ \url{https://doi.org/10.1186/1471-2105-7-91}
\end{itemize}
